import { QR8bitByte as BitByte } from "./8BitByte";
...
export class QRCode {
  ...
  private readonly errorCorrectLevel: 0 | 1 | 2 | 3;
  ...
  getBestMaskPattern() {
    ...
    for (let i = 0; i < 8; i++) {
      ...
      let lostPoint = getLostPoint(this);
...
function createBytes(buffer: BitBuffer, rsBlocks: QRRSBlock[]): number[] {
  ...
  for (var r = 0; r < rsBlocks.length; r++) {
    ...
    var rsPoly = getErrorCorrectPolynomial(ecCount as 0 | 1 | 2 | 3);
